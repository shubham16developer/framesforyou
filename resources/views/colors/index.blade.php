        ...
        <div id="kt_app_toolbar" class="app-toolbar py-3 py-lg-6">
            ...
            <div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
                ...
                <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                    <!--begin::Title-->
                    <h1 class="page-heading d-flex text-dark fw-bold fs-3 flex-column justify-content-center my-0">Color
                    </h1>
                    <!--end::Title-->
                    <!--begin::Breadcrumb-->
                ...
                @if (Auth::user()->role == 'Admin')
                    <div class="d-flex align-items-center gap-2 gap-lg-3">
                        ...
                        <a href="{{ url('colors/add') }}" class="btn btn-sm fw-bold btn-primary">Add Color</a>
                        <!--end::Primary button-->
                    </div>
                @endif
                <!--end::Actions-->
                ...
                <div class="card">
                    ...
                    <div class="card-header card-header-stretch">
                        ...
                        <div class="card-title">
                            <h3 class="m-0 text-gray-800">Color</h3>
                        </div>
                    </div>
                    <!--end::Header-->
                    <!--begin::Tab Content-->
                                ...
                                <table class="table table-flush align-middle table-row-bordered table-row-solid gy-4 gs-9"
                                    ...
                                    <thead class="border-gray-200 fs-5 fw-semibold bg-lighten">
                                        <tr>
                                            ...
                                            <th class="min-w-175px ps-9">Color Name</th>
        ...
        $(document).ready(function() {
            ...
            "columns": [{
                ...
                },
                {
                    ...
                    render: function(data, type, row, meta) {
                        $id = (row.id);
                        $html = '<a href="{{ url('colors/edit') }}/' + btoa($id) +
