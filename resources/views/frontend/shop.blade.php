		...
		<div class="container">
			...
			<div class="flex-w flex-sb-m p-b-52">
				...
				@foreach($categories as $category)
					...
					<button class="stext-106 cl6 hov1 bor3 trans-04 m-r-32 m-tb-5" data-filter=".{{$category->cat_name}}">
						{{$category->cat_name}}
					</button>
			...
			<div class="row isotope-grid">
				...
				<div class="col-sm-6 col-md-4 col-lg-3 p-b-35 isotope-item {{$product->product_category->cat_name}}">
					<!-- Block2 -->
					<div class="block2">
						<div class="block2-pic hov-img0">
							<img src="{{ url('/upload/product_images') }}/{{$product->image}}" style="aspect-ratio: 16 / 16;" alt="IMG-PRODUCT">
