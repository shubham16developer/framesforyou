        ...
        <div id="kt_app_toolbar" class="app-toolbar py-3 py-lg-6">
            ...
            <div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
                ...
                <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                    <!--begin::Title-->
                    <h1 class="page-heading d-flex text-dark fw-bold fs-3 flex-column justify-content-center my-0">Security
                    </h1>
                    <!--end::Title-->
                    <!--begin::Breadcrumb-->
                ...
                <!--begin::Actions-->
                    <div class="d-flex align-items-center gap-2 gap-lg-3">
                        ...
                        <a href="{{ url('security/add') }}" class="btn btn-sm fw-bold btn-primary">Add Security</a>
                        <!--end::Primary button-->
                    </div>
                <!--end::Actions-->
            </div>
                ...
                <div class="card">
                    ...
                    <div class="card-header card-header-stretch">
                        ...
                        <div class="card-title">
                            <h3 class="m-0 text-gray-800">Security</h3>
                        </div>
                    </div>
                    <!--end::Header-->
                    <!--begin::Tab Content-->
               ...
               
                    {
                        ...
                        render: function(data, type, row, meta) {
                            $id = (row.id);
                                ...
                                $html = '<a href="{{ url('security/edit') }}/' + btoa($id) +
